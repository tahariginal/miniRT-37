...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/28 14:47:10 by tkoulal           #+#    #+#             */
/*   Updated: 2024/09/28 14:47:11 by tkoulal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_line_1(char **param, size_t count, t_parser *parser)
{
...
int	check_line(char *line, t_scene *scene, t_parser *parser)
{
	...
	else if (ft_strcmp(param[0], "A") == 0)
	{
		...
		return (check_line_1(param, count, parser));
	return (free_array(param), SUCESS);
}
